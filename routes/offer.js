...
//   try {
// FIND
// const regExp = /Rouge/i;
// const regExp = new RegExp(`Rouge`, "i");
...
//     $lte: 100,
//   },
//   product_name: new RegExp("rouge", "i")
...
// SKIP permet d'ignorer des résultats et LIMIT permet de limiter le nombre de résultats trouvés
...
// Si je veux aller chercher un élément dont la marque est adidas :

// const offer = await Offer.findOne({ "product_details[0].MARQUE": "Adidas" });
